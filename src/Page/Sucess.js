...
const Sucess = () => {
  ...
  return (
    ...
    <div className=" w-full h-[5vh] flex items-center justify-center space-x-2  text-sm font-medium">
<span>
<Link to="/" className="hover:text-blue-300 transition duration-200 ease-in-out text-white">
  Home
</Link>
</span>
<span className="text-znic-50">/</span>
<span className="text-zinc-50">Success</span>
</div>
...
<tr key={index} className="hover:bg-zinc-900 hover:text-zinc-50 transition duration-200 ease-in-out border-b text-white ">
  ...
  <span className="px-4 py-2 bg-sky-600 font-medium">{item.status}</span>
</td>
